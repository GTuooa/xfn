...
class FirstSection extends React.Component {
	...
	render() {
		...
		const { gainAndLoss, income, pay, didMount } = this.props
					...
					<div className="ambsyb-firstsection-main-left">
						...
						<div className="ambsyb-piechar-legend">
							<span className="ambsyb-piechar-amount-left">
								<span className="ambsyb-piechar-name-income">{`${income === '' ? '0.00' : formatMoney(income, 2, '')}`}</span>
							...
							<span className="ambsyb-piechar-amount-right">
								...
								<span className="ambsyb-piechar-name-pay">{`${pay === '' ? '0.00' : formatMoney(pay, 2, '')}`}</span>
							</span>
						</div>
					</div>
                </div>
