...
class TreeContain extends React.Component {
	...
	static displayName = 'InventoryConfTreeContain'
				...
				<span>
					<Select
						...
						onSelect={value => {
							...
							const uuid = info[0]
							const name = info[1]
							dispatch(inventoryConfActions.getInventoryCardListByType(parentUuid, uuid, name))
						}}
						showArrow={false}
					>
				...
				<div className="table-right-tree">
					<JxcTree
						...
						onSelect={(info) => {
							...
							dispatch(inventoryConfActions.getInventoryCardListByType(parentUuid, uuid, name,1))
						}}
					/>
				</div>
			</TableTree>
