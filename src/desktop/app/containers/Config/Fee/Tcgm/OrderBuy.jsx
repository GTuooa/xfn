...
// 		const equityName = upgradeOrBuyStatu.get('equityName')
// 		const index = upgradeOrBuyStatu.get('index')
// 		const orderItem = equityName && typeof index === 'number' ? upgradeOrBuyList.getIn([equityName, index]) : fromJS({})

// 		return equityName && typeof index === 'number' && orderItem ?
//             <Modal
//                 title="订单详情"
...
//                     <p>企业名称：{corpName}</p>
//                     <p>购买套餐：{orderItem.get('equityName') + orderItem.get('relateNumber')}</p>
//                     <p>金额：{orderItem.get('payFee')}元</p>
