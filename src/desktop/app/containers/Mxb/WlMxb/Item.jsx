	...
	render() {
		...
		return (
			<TableItem className={className} line={idx}>
				<li>{dateYmd}</li>
				<li>
					<span className="account-flowNumber"
					onClick={() => {
				...
				<TableOver className="amountwlmx-title-cell">
					<div className="amountwlmx-item-second-footer">
						<Amount>{mxitem.get('happenIncomeAmount')}</Amount>
						<Amount>{mxitem.get('happenExpenseAmount')}</Amount>
					</div>
				</TableOver>
				<TableOver className='amountwlmx-title-cell'>
					<div className="amountwlmx-item-second-footer">
						<Amount>{mxitem.get('paymentIncomeAmount')}</Amount>
						<Amount>{mxitem.get('paymentExpenseAmount')}</Amount>
					</div>
				</TableOver>
				<TableOver>{mxitem.get('direction')}</TableOver>
				<TableOver>
