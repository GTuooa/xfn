...
// import * as editRunningActions from 'app/redux/Edit/LrAccount/lrAccount.action.js'
...
//         onCancel={() => {
//             dispatch(editRunningActions.changeLrAccountCommonString('', ['flags', 'showContactsModal'], false))
...
//                                     if(uuid === 'all'){
//                                         dispatch(editRunningActions.getAllManagesCardList(currentCardType,runningState,cardRange,modalName))
//                                     }else{
//                                         dispatch(editRunningActions.getCalculateCardList(runningDate,uuid,level))
//                                     }
//                                 }else{
//                                     if(fromCarryOver){
//
//                                         if(uuid === 'all'){
//                                             dispatch(editRunningActions.getCostStockList(runningDate,runningState))
//                                         } else {
//                                             dispatch(editRunningActions.getCostCardTypeList(runningDate,runningState,uuid,level))
//                                         }
//                                     }else{
//                                         if (currentCardType === 'project') {
//                                             if(uuid === 'all'){
//                                                 dispatch(editRunningActions.getProjectAllCardList(projectRange,modalName,true))
//                                             } else {
//                                                 dispatch(editRunningActions.getProjectSomeCardList(uuid,level))
//                                             }
//                                         } else {
//                                             if(uuid === 'all'){
//                                                 dispatch(editRunningActions.getAllCardList(currentCardType,runningState,cardRange,modalName))
//                                             } else {
//                                                 dispatch(editRunningActions.getCurrentCardList(currentCardType,runningState,uuid,level))
//                                             }
//                                         }
//
//                                     }
...
//                                     dispatch(editRunningActions.searchCardList(true,selectList))
//                                 } else {
//                                     dispatch(editRunningActions.searchCardList(false,thingsList))
//                                 }
//                             }}
//                         />
//                     </span>
...
//                                         if (palceTemp === 'calculate') {
//
//                                             dispatch(editRunningActions.changeLrAccountCommonString(palceTemp, 'usedCard' ,fromJS({uuid:v.uuid,name:v.name,code:v.code})))
//                                             dispatch(editRunningActions.changeLrAccountCommonString(palceTemp, 'cardUuid' , v.uuid))
//                                             if(runningDate) {
//                                                 dispatch(editRunningActions.getBusinessList(runningDate,  v.uuid))
//                                             }
//                                         } else {
//                                             if (currentCardType === 'project') {
//                                                 if(fromDepreciation){
//                                                     const amount = lrCalculateState.getIn(['DepreciationTemp', 'amount'])
...
//                                                   dispatch(editRunningActions.changeLrAccountCommonString(palceTemp,['detail','projectCard',index] ,fromJS({uuid:v.uuid,name:v.name,code:v.code,amount:curAmount})))
//                                                 } else{
//                                                     dispatch(editRunningActions.changeLrAccountCommonString(palceTemp,['projectCard',index] ,fromJS({uuid:v.uuid,name:v.name,code:v.code,amount:curAmount})))
//                                                 }
//
//                                             } else if (currentCardType === 'stock') {
//                                                 dispatch(editRunningActions.changeLrAccountCommonString(palceTemp, place ,fromJS({uuid:v.uuid,name:v.name,code:v.code,amount:curAmount})))
//                                                 dispatch(editRunningActions.changeLrAccountCommonString('ori', [categoryTypeObj, 'carryoverCardList', index] , fromJS({uuid:v.uuid,name:v.name,code:v.code})))
//                                             } else {
//                                                 dispatch(editRunningActions.changeLrAccountCommonString(palceTemp, place ,fromJS({uuid:v.uuid,name:v.name,code:v.code})))
//                                             }
//                                             if(fromCarryOver){
...
//                                             }
//                                         }
//                                         dispatch(editRunningActions.changeLrAccountCommonString('', ['flags', modalName], false))
//                                     }}
//                                 >
//                                 <li>{v.code}</li>
//                                 <li>{v.name}</li>
