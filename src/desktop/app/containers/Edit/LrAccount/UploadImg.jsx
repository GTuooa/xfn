...
//
// 			this.props.dispatch(lrAccountActions.switchLoadingMask())
//
...
// 			this.props.dispatch(lrAccountActions.uploadFiles(this.props.dirUrl, file, this.props.PageTab,this.props.paymentType))
// 			if(i+1 === length){
// 				eleFile.value = ''
// 				this.props.dispatch(lrAccountActions.switchLoadingMask())
// 			}
...
// 		// 	showFj = false
// 		// }
// 		const isShowBtn = PageTab === 'business' ? !specialStateforAccrued : !isQuery
// 		return (
...
// 													dispatch(lrAccountActions.getLabelFetch(PageTab,paymentType))
// 												}
// 											}}
...
// 									onClick={()=>{ dispatch(lrAccountActions.deleteUploadFJUrl(i,PageTab,paymentType)) }}
// 									>
// 									<Icon type="close" />
// 								</div>
// 						</div>) }
...
// 						style={{display:isShowBtn && deleteAndLabel && enclosureList.size<9 && checkMoreFj ? '' : 'none'}}
// 						onClick={(e) => {
// 							dispatch(lrAccountActions.getUploadGetTokenFetch())
// 						}}
// 						>
// 						<input
// 							type="file"
...
// 					onOk={()=>{
// 						if(label.size){
// 							dispatch(lrAccountActions.changeTagName(currentIdx,tagValue,PageTab,paymentType))
// 						}
...
// 							<div>旋转</div>
// 						</button>
// 						<button disabled={ !lrPermissionInfo.getIn(['edit', 'permission']) } >
// 							{
// 								!lrPermissionInfo.getIn(['edit', 'permission']) ?
// 								<a>
// 									<Icon type="download" />
// 									<div>下载</div>
// 								</a> :
...
// 						<img src={previewImgArr.getIn([page, 'enclosurePath'])} style={{transform:`rotate(${rotate}deg)`, width:`${wpercent}%`}}/>
// 					</div>
