							...
							categoryTypeList.map((v, i) => {
								...
								return (
									<Row key={i}
										...
										onClick={()=> {
											dispatch(homeAccountActions.changeLrlsData(['inventory', 'psiData', 'categoryTypeList', i, 'checked'], !checked))
											if (!checked) {//变为选中时
												dispatch(homeAccountActions.getInventorySettingCardTypeList(v.get('ctgyUuid'), i))
											}
										}}
									>
