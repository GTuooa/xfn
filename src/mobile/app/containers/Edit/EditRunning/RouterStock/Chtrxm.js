...
export default class Chtrxm extends Component {
    ...
    render () {
        const { dispatch, idx, cardData, stockList, warehouseList, isOpenedWarehouse, onClick, assistClick, batchList, serialMultipleList, isModify, oriUuid } = this.props
        ...
        const amountDisabled = v.get('cardUuid') ? false : true
